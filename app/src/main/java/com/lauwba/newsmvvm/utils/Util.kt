package com.lauwba.newsmvvm.utils
...
import com.lauwba.newsmvvm.R
import com.lauwba.newsmvvm.model.Article

fun sahreNews(context: Context?, article: Article){
...
//tak efrom swiperefreshlayout : CurcularProgressDrwawable
